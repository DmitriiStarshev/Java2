...
public class Main {
    public static void main(String[] args) throws JsonProcessingException {
        ...
        List<Car> carList = new ArrayList<>(Arrays.asList(new Car("Черная", " Mercedes"),
                new Car("Read", " Renault")));
...
//        objectMapper.configure(DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES,false);
        ...
        Car carFromJsonAfterRefacroring = objectMapper.readValue(jsonCarAfterRefactoring, Car.class);
        System.out.println(carFromJsonAfterRefacroring);
